...
public class biomes {
    ...
    @PythonFunction
    @PythonDocString("Returns a list of all the Biomes.  This will include mod biomes that were registered correctly.")
    ...
    private static PyList func02(boolean includeModBiomes) {
