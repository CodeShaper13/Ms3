...
/**
 * Instructions that are created from called to the api. These are later read to
 * drawn on the screen.
 * 
 * @author CodeShaper
 */
public class DrawInstructions {
	...
	public DrawInstructions addVert(PyTuple vertex) {
		this.verticies.add(Parser.tupleToVertex(vertex));
		return this;
	}
	...
	public DrawInstructions setColor(PyTuple color) {
		this.color = Parser.tupleToColor(color);
		return this;
	}
	...
	/**
	 * Draws these instructions on the screen.
	 */
	public void draw() {
